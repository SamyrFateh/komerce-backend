...
--
--            F1-B ACTIVÉ après live data preflight du 2026-09-15 :
--              total_orders = 0
--              orders_without_relais_id = 0
--              orders_with_orphan_relais_reference = 0
--              orders_without_market_id = 0
--              orders_market_relais_mismatch = 0
--            Audit canonique exécuté en transaction READ ONLY + ROLLBACK via
--            scripts/audit-f1-market-integrity.sql (PR d'audit #1530).
