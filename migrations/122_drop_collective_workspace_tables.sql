-- ============================================================
-- Migration 122 : Éradication de l'îlot collective (Lot 1 — Boutique First)
-- Date : août 2026
--
-- CONTEXTE :
...
DO $$
BEGIN
  RAISE NOTICE 'Migration 122 — début éradication îlot collective.';
END $$;
...
DO $$
BEGIN
  RAISE NOTICE 'Migration 122 OK — 7 tables collective_* et types associés supprimés.';
END $$;
