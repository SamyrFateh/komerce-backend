...
VALUES
  ...
  ('Soldes','Soldes','Soldes','🏷️','<svg viewBox="0 0 24 24"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg>','{}','promo',1,TRUE,TRUE),
  ('Mode & Beauté','Mode & Beauté','Mode','👗','<svg viewBox="0 0 24 24"><path d="M20.38 3.46 16 2a4 4 0 0 1-8 0L3.62 3.46a2 2 0 0 0-1.34 2.23l.58 3.47a1 1 0 0 0 .99.84H6v10c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V10h2.15a1 1 0 0 0 .99-.84l.58-3.47a2 2 0 0 0-1.34-2.23z"/></svg>',ARRAY['Mode','Beauté'],NULL,2,TRUE,TRUE),
  ('Tech','Tech','Tech','📱','<svg viewBox="0 0 24 24"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg>',ARRAY['Tech'],NULL,3,TRUE,TRUE),
  ('Enfant','Enfant','Enfant','🧒','<svg viewBox="0 0 24 24"><circle cx="12" cy="7" r="5"/><path d="M12 12v10M7 22h10"/></svg>',ARRAY['Enfant'],NULL,4,TRUE,TRUE),
  ('Maison','Maison','Maison','🏠','<svg viewBox="0 0 24 24"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>',ARRAY['Maison'],NULL,5,TRUE,TRUE),
  ('Sport','Sport','Sport','⚽','<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M6.5 6.5 17.5 17.5M4 12h.01M20 12h.01M12 4v.01M12 20v.01"/></svg>',ARRAY['Sport'],NULL,6,TRUE,TRUE),
  ('Sur-mesure','Sur-mesure','Pour vous...','✨','<svg viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01z"/></svg>',ARRAY['Sur-mesure'],NULL,7,TRUE,TRUE)
ON CONFLICT (key) DO NOTHING;

INSERT INTO boutique_subcategories (category_key, key, label, short_label, icon, display_order)
VALUES
