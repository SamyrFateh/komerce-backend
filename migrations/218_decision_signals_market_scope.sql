-- @migration 218_decision_signals_market_scope.sql
...
-- The active-fact identity must include market_id. The former index would
-- collapse the same product/order fact across two different countries.
