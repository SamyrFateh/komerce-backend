-- @migration 222_decision_signals_market_scope.sql
...
-- Active-fact identity includes the market. The former index would collapse
-- the same product/order fact across two different countries.
