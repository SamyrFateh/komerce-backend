...
export const FinanceView: React.FC = () => {
  const { data: financeData, loading, error, reload, usingMock } = useApi(() => api.finance(), mockFinanceData, 15000);
  const { kpi, paiements, marges, par_categorie, top_produits, taux } = financeData!;
