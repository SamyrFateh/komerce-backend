...
const ALLOWED_LARGE_FILES = new Set([
  ...
  'services/radar-queries.js',                   // 857 l  → Lot B7 : allowlisté, 29 tests présents, seul appelant admin-radar.js, pas de croissance prévue
  'routes/shared-cart.js',                       // 989 l  → Lot B7 : allowlisté, webhook Stripe inline, service déjà extrait côté C1
  // 'services/dashboard-finance-metrics.js' retiré — Lot B7 clôturé 2026-06-28 :
  // barrel 13L → services/finance-metrics/{finance-summary,annulations,payments,sales-analysis,index}.js
  // aucun fragment > 490L. Voir tests/unit/dashboard-finance-metrics.test.js (14 cas).
  // 'services/notification-service.js' retiré — Lot C2 clôturé 2026-06-28 :
  // barrel 39L → services/notifications/{internals,order,parcel,otp-auth,loyalty,misc}.js
