...
module.exports = {
  ...
  contract: {
    exposes: [
      ...
      // câblées via des fichiers déjà possédés par dashboard, jamais
      // déclarées jusqu'ici.
      ...
      'GET /api/admin/workspaces/accounting/market/:marketCode',
      ...
      'POST /api/admin/workspaces/operations/market/:marketCode/distribution/run',
      'POST /api/admin/workspaces/operations/market/:marketCode/inventory/items/:itemId/assign',
      'POST /api/admin/workspaces/operations/market/:marketCode/orders/:reference/confirm-cash',
      'POST /api/admin/workspaces/operations/market/:marketCode/orders/:reference/mark-ordered',
      'POST /api/admin/workspaces/operations/market/:marketCode/parcels/:reference/collect',
      'POST /api/admin/workspaces/operations/market/:marketCode/parcels/:reference/receive',
      'POST /api/admin/workspaces/operations/market/:marketCode/parcels/:reference/ship',
      'GET /api/admin/workspaces/shipping-customs/market/:marketCode',
      'POST /api/admin/workspaces/shipping-customs/market/:marketCode/customs/shipments',
      'POST /api/admin/workspaces/shipping-customs/market/:marketCode/customs/shipments/:reference/activate',
      'POST /api/admin/workspaces/shipping-customs/market/:marketCode/customs/shipments/:reference/deactivate',
      'POST /api/admin/workspaces/shipping-customs/market/:marketCode/customs/shipments/:reference/declare',
      'POST /api/admin/workspaces/shipping-customs/market/:marketCode/customs/shipments/:reference/update',
      'POST /api/admin/workspaces/shipping-customs/market/:marketCode/parcels/:reference/confirm-transit',
    ],
    consumes: [
  ...
  files: {
    ...
    tests: [
      ...
      'tests/unit/parcel-reference-dashboard-regression.test.js',
      'tests/unit/parcel-reference-order-360-regression.test.js',
      'tests/unit/parcel-reference-runtime-contract.test.js',
      ...
      'tests/unit/parcel-reference-signal-drift.todo.test.js',
      'tests/unit/business-alignment-closure.test.js',
      'tests/unit/canonical-accounting-workspace-decision.test.js',
      'tests/unit/canonical-client-360-app.test.js',
      'tests/unit/canonical-client-360-boundary.test.js',
      'tests/unit/canonical-client-360.test.js',
      'tests/unit/canonical-client-router-v4.test.js',
      'tests/unit/canonical-commerce.test.js',
      'tests/unit/canonical-control-tower-cutover.test.js',
      'tests/unit/canonical-costing-cutover.test.js',
      'tests/unit/canonical-dashboard-drills-role-aware.test.js',
      'tests/unit/canonical-dashboard-drills.test.js',
      'tests/unit/canonical-finance-coverage-boundary.test.js',
      'tests/unit/canonical-finance.test.js',
      'tests/unit/canonical-finish-polish-v1.test.js',
      'tests/unit/canonical-hybrid-shell-v4.test.js',
      ...
      'tests/unit/canonical-operations-workspace-decision.test.js',
      'tests/unit/canonical-operations-workspace.test.js',
      'tests/unit/canonical-operations.test.js',
      ...
      'tests/unit/canonical-pricing-decision-chain.test.js',
      'tests/unit/canonical-pricing-economic-cockpit.test.js',
      'tests/unit/canonical-pricing-equilibrium-panel.test.js',
      'tests/unit/canonical-primitives-contract.test.js',
      ...
      'tests/unit/canonical-shipping-customs-workspace-boundary.test.js',
      'tests/unit/canonical-shipping-customs-workspace-decision.test.js',
      'tests/unit/canonical-sourcing-workspace-decision.test.js',
      'tests/unit/canonical-standalone-shell-v4.test.js',
      'tests/unit/canonical-theme-v2.test.js',
      'tests/unit/canonical-visual-freeze.test.js',
