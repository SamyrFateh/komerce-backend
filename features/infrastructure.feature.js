...
module.exports = {
  ...
  files: {
    ...
    tests: [
      ...
      'tests/unit/require-non-production.test.js',
      'tests/unit/ensure-staging-market-relays.test.js',
      'tests/unit/relay-map-csp.test.js',
      'tests/unit/r5-prod-guard.test.js',
      'tests/unit/validate.test.js',
      'tests/unit/agent-remediation-contract.test.js',
      ...
      'tests/unit/contract-check-runtime-scan.test.js',
      'tests/unit/controlled-business-purge.test.js',
      'tests/unit/debt-zero-gate.test.js',
      'tests/unit/feature-360-internal-api-projection.test.js',
      'tests/unit/feature-dependency-data-channel.test.js',
      ...
      'tests/unit/pr-enforcement-golden-scope.test.js',
      'tests/unit/pr-enforcement-package-json-scope.test.js',
      'tests/unit/pr-enforcement-scope.test.js',
      'tests/unit/pr-enforcement-security360-scope.test.js',
      ...
      'tests/unit/touched-tests-gate-coverage-thresholds.test.js',
      'tests/unit/touched-tests-gate-css.test.js',
      'tests/unit/shadow-domains-boundary.test.js',
      'tests/unit/business-graph-determinism.test.js',
      'tests/unit/business-graph-warning-semantics.test.js',
      'tests/unit/business-graph-warning-stream.test.js',
      'tests/unit/pr-enforcement-business-graph-runtime-scope.test.js',
      'tests/unit/arch-drift-pending-migration.test.js',
      'tests/unit/bootstrap-api-routes.test.js',
      'tests/unit/bootstrap-crons.test.js',
      'tests/unit/bootstrap-env.test.js',
      'tests/unit/bootstrap-html-routes.test.js',
      'tests/unit/bootstrap-security.test.js',
      'tests/unit/bootstrap-server-lifecycle.test.js',
      'tests/unit/bootstrap-startup-migrations.test.js',
      'tests/unit/check-currency-format.test.js',
      'tests/unit/check-currency-truncation.test.js',
      'tests/unit/check-migration-immutability.test.js',
      'tests/unit/check-schema-freshness.test.js',
      'tests/unit/check-schema-resurrection.test.js',
      'tests/unit/check-sku-coverage.test.js',
      'tests/unit/ci-migrate.test.js',
      'tests/unit/db-numeric-type-parser.test.js',
      'tests/unit/railway-migration-deploy-contract.test.js',
      'tests/unit/schema-promote-columns.test.js',
