...
module.exports = {
  ...
  files: {
    ...
    tests: [
      ...
      'tests/integration/txg02-pricing-strategy-service.test.js',
      'tests/unit/admin-finance-config-relay-retired.test.js',
      'tests/unit/admin-pricing-workspace-structure-events-route.test.js',
      'tests/unit/pricing-cdr-currency-allocation.test.js',
      'tests/unit/pricing-cdr-fx.test.js',
      'tests/unit/pricing-observed-cost-truth.test.js',
      'tests/unit/sourcing-analysis-density.test.js',
      'tests/unit/relay-commission-allocation.test.js',
      'tests/unit/relay-commission.test.js',
