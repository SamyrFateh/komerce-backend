...
module.exports = {
  ...
  files: {
    ...
    services: [
      ...
      'services/sourcing-catalog-change-observation.js',
      'services/sourcing-catalog-change-unit-resolution-proof.js',
      'services/sourcing-catalog-change-sku-identity-proof.js',
      ...
      'services/sourcing-integrity-service.js',
      ...
      'services/sourcing-canonical-unit-projection.js',
      'services/sourcing-canonical-unit-product-sku-resolution.js',
      'services/sourcing-canonical-offer-unit-comparison.js',
      'services/sourcing-shadow-quantity-trial.js',
    ...
    tests: [
      ...
      'tests/unit/sourcing-catalog-change-observation.test.js',
      'tests/unit/sourcing-catalog-change-unit-resolution-proof.test.js',
      'tests/unit/sourcing-catalog-change-sku-identity-proof.test.js',
      'tests/integration/catalog-change-unit-resolution-proof-real-db.test.js',
      'tests/integration/catalog-change-sku-identity-proof-real-db.test.js',
      'tests/integration/catalog-change-unit-stock-observation-real-db.test.js',
      ...
      'tests/unit/sourcing-canonical-unit-product-sku-resolution.test.js',
      'tests/unit/sourcing-canonical-offer-unit-comparison.test.js',
      'tests/unit/sourcing-shadow-quantity-trial.test.js',
  ...
  contract: {
    ...
    internalApi: [
      ...
      { fn: 'recordUnitStockChange', file: 'services/sourcing-catalog-change-observation.js' },
      { fn: 'proveExactCanonicalUnitForStockDelta', file: 'services/sourcing-catalog-change-unit-resolution-proof.js' },
      { fn: 'proveExactCatalogSkuForStockDelta', file: 'services/sourcing-catalog-change-sku-identity-proof.js' },
      ...
      { fn: 'collectIntegrityAudit', file: 'services/sourcing-integrity-service.js' },
      { fn: 'buildHealthDashboard', file: 'services/sourcing-integrity-service.js' },
      { fn: 'buildFinalAuthoritySnapshot', file: 'services/sourcing-integrity-service.js' },
      ...
      { fn: 'resolveCanonicalUnitForProductSku', file: 'services/sourcing-canonical-unit-product-sku-resolution.js' },
      { fn: 'compareCanonicalOfferUnitWithLegacy', file: 'services/sourcing-canonical-offer-unit-comparison.js' },
