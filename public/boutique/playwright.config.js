...
module.exports = defineConfig({
  ...
  projects: [
    ...
    // (volet 3.3) sans rien gagner (volet 3.2 ne teste que du layout/CSS).
    {
      ...
      testMatch: ['**/modal-geometry.spec.js', '**/modal-visual-regression.spec.js', '**/hero-geometry.spec.js', '**/modal-backtop-zindex.spec.js', '**/csp-fronts.spec.js'],
      use: {
        ...devices['Desktop Chrome'],
        locale: 'fr-FR',
      },
    ...
    {
      name: 'Desktop Chrome',
      testIgnore: ['**/authenticated/**', '**/modal-mdm9-gallery-layout.spec.js', '**/modal-geometry.spec.js', '**/modal-visual-regression.spec.js', '**/hero-geometry.spec.js', '**/modal-backtop-zindex.spec.js', '**/csp-fronts.spec.js'],
      use: {
        ...devices['Desktop Chrome'],
        viewport: { width: 1280, height: 800 },
        locale: 'fr-FR',
