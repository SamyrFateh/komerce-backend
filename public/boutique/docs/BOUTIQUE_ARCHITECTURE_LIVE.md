...
> Régénération : `npm run boutique:arch`. Date : 2026-06-26T13:36:20.092Z
>
...
```
 1. /boutique/css/dist/base.css?v=110
 2. /boutique/css/dist/components.css?v=122
 3. /boutique/css/dist/desktop.css?v=45
 4. /boutique/css/dist/event.css?v=27
```
...
|---|---|
| `.k-chip` ⚠️ | `categories.css` (39/11)<br>`interactions.css` (1/0) |
| `.k-cats-shell` ⚠️ | `boutique-desktop.css` (0/1)<br>`categories.css` (2/2)<br>`hero.css` (1/0) |
| `.k-hero-cats-sticky` ⚠️ | `categories.css` (0/2)<br>`hero.css` (3/2) |
...
| `.k-card` ⚠️ | `boutique-desktop.css` (0/2)<br>`categories.css` (9/0)<br>`products.css` (7/13) |
| `.k-card-add` ⚠️ | `cart.css` (0/2)<br>`products.css` (10/4) |
| `.k-card-fav` ⚠️ | `cart.css` (0/1)<br>`products.css` (4/3) |
| `.k-side-cart` ⚠️ | `boutique-desktop.css` (0/7)<br>`layout.css` (2/0) |
| `#k-desktop-catalog-wrap` | `layout.css` (1/5) |
| `.k-header` | `layout.css` (9/5) |
| `.k-hero-media` | `hero.css` (4/4) |
| `.k-modal` ⚠️ | `modal-product.css` (0/1)<br>`modal-shell.css` (5/2) |
