...
| `modal-mobile-canonical.css` | 533 | 🔴 **ORPHELIN** |
| `modal-product-lot4-hybrid.css` | 446 | 🔴 **ORPHELIN** |
| `modal-product.css` | 1352 | 🔴 **ORPHELIN** |
| `modal-shell.css` | 1016 | 🔴 **ORPHELIN** |
...
```
 ...
 2. /boutique/css/dist/components.css?v=184
