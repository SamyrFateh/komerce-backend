...
| **Side-cart desktop** `.k-side-cart*` | boutique-desktop.css (17), layout.css (10), hero.css (1) | 3 | 🔴 |
...
| `b-modal-core.js` | 30 | 54 | 3/3 | Modal produit, Side-cart desktop, Carte produit, Grille produits |
