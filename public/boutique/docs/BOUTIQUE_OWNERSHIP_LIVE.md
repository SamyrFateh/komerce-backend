...
| `b-cart.js` | 55 | 26 | 4/8 | Side-cart desktop, Panier, Carte produit, Chips catégories, Bottom-nav mobile |
...
| `b-tracking.js` | 19 | 0 | 1/0 | Section catalogue |
...
| shared-list-lists-tab.css | 430px | 🔴 430px |
