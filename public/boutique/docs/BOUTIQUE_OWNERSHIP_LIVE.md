...
| `b-checkout.js` | 59 | 4 | 0/1 | Bottom-nav mobile |
| `b-checkout-render.js` | 55 | 0 | 0/0 | — |
...
| `b-wallet.js` | 21 | 0 | 0/0 | Section catalogue |
...
| `b-group-view.js` | 10 | 2 | 0/1 | Header, Panier groupe, Bottom-nav mobile, Section catalogue |
