...
const bundles = [
  ...
  {
    out: 'components.css',
    label: 'components — categories · products · modal · cart · cart-product-open · group-cart-flow · shared-followup · interactions · hero-cart-proxy',
    files: ['categories', 'products', 'modal', 'cart', 'cart-product-open', 'group-cart-flow', 'shared-followup', 'interactions', 'hero-cart-proxy'],
  },
  {
    out: 'desktop.css',
  ...
  {
    out: 'event.css',
    label: 'event — (garder séparé, chargé uniquement sur /event/*)',
    files: ['event'],
  },
];
let totalIn = 0;
