...
const BUNDLES = [
  ...
  {
    out: 'components.css',
    files: ['categories', 'category-cutout-navigation', 'products', 'discovery-rail', 'spike-vertical-shell', 'modal-shell', 'modal-media', 'modal-product', 'modal-product-lot4-hybrid',
