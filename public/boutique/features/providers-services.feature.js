...
module.exports = {
  ...
  perimeter: {
    ...
    out: [
      ...
      'rendu de la fiche et choix demander/rappel — catalog',
      'contact direct call/whatsapp provider depuis la Boutique',
  ...
  contract: {
    ...
    consumes: [
      'catalog — signal discovery:request portant kind/ref/source/requestedWindow/requesterNote et action optionnelle callback',
  ...
  invariants: [
    ...
    'aucun lien call/whatsapp provider n’est créé par cette slice',
    ...
    'une Inquiry sur physical_offer n’appelle jamais orders ni checkout',
  ],
};
