...
module.exports = {
  ...
  perimeter: {
    in: [
      ...
      'contrat de présentation Discovery : réemploi du shell visuel canonique k-card et entrée unique vers le détail Komerce',
    ],
    out: [
      ...
      'second shell visuel de carte Discovery parallèle au Product Display Contract canonique',
    ],
  },
  ...
  files: {
    ...
    tests: [
      ...
      '../tests/unit/discovery-canonical-card-contract.test.js',
  ...
  contract: {
    ...
    internalApi: [
      ...
      'render-product-card.js / renderProductCard — source du shell visuel canonique k-card',
      'render-discovery-rail.js / renderDiscoveryRail — projection Discovery dans le shell k-card canonique',
  ...
  invariants: [
    ...
    'Product, Physical Offer et Service réutilisent le shell visuel canonique k-card ; .k-discovery-card reste un hook comportemental et ne possède jamais de géométrie CSS autonome',
    'les capacités Discovery occupent les slots canoniques k-card-img-wrap, k-card-info, k-card-name, k-card-bottom et k-card-add ; une donnée optionnelle ne crée jamais un second modèle de carte',
