...
module.exports = {
  ...
  perimeter: {
    in: [
      ...
      'surface frontend du rail Discovery local sur l accueil Tout uniquement (mobile et desktop) ; sans possession des vérités local-stock/providers-services/recommendations',
      ...
      'fiche Discovery contextualisée dans le même #k-modal : physical_offer conserve demander/rappel ; service possède une composition dédiée et peut proposer un handoff WhatsApp après Inquiry',
    ...
    out: [
      ...
      'contact brut provider call/tel ou WhatsApp sans identité et Inquiry préalables',
      'résolution du numéro ou construction de l URL WhatsApp — owner providers-services backend',
  ...
  contract: {
    ...
    internalApi: [
      ...
      'b-modal-discovery-detail.js / setupDiscoveryModalDetail / renderDiscoveryModalDetail / normalizeActions — surface service dédiée, fallback demander/rappel et CTA WhatsApp sans contact brut',
      'discovery-actions.js / requestDiscovery — producteur unique discovery:request pour request|callback avec requestedWindow/requesterNote et handoff whatsapp service optionnel',
    ...
    consumes: [
      ...
      'providers-services — détail public Service/Physical Offer avec actions request/callback ; Service peut signaler whatsapp_available sans exposer la coordonnée',
      'providers-services — POST Inquiry possède la résolution serveur du handoff WhatsApp service',
  ...
  invariants: [
    ...
    'Disponible ici est natif sur l accueil Tout uniquement, sur mobile comme sur desktop ; une catégorie reste une surface catalogue pure quelle que soit l entrée (tap de puce ou swipe horizontal)',
    ...
    'sur mobile, la surface Discovery conserve son 2×2 vertical historique sur Tout, sans réintroduire aucun scroller horizontal interne au pager catégories',
    'sur mobile, le scroll vertical ne change jamais de catégorie : arriver en bas d une catégorie ne déclenche aucun passage ; on change de catégorie uniquement par puce ou swipe horizontal',
    'une fiche physical_offer ne propose publiquement que demander et/ou être rappelé ; un Service peut en plus proposer Discuter sur WhatsApp comme handoff après Inquiry sans changer son kind',
    ...
    'aucun téléphone provider, lien tel: ou URL wa.me n est construit par le détail Discovery ; le bouton WhatsApp ne fait qu émettre le handoff canonique providers-services',
    'un Service n expose jamais Ajouter au panier ni Acheter maintenant ; ces actions restent réservées au Product Komerce',
