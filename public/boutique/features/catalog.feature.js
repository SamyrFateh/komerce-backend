...
module.exports = {
  ...
  perimeter: {
    in: [
      ...
      'surface frontend du rail Discovery local sur l accueil Tout uniquement, sans possession des vérités local-stock/providers-services/recommendations',
  ...
  invariants: [
    ...
    'Disponible ici appartient uniquement à l accueil Tout ; aucun onglet catégorie ne monte ni ne conserve le rail Discovery, sur desktop comme sur mobile',
    ...
    'sur mobile, la surface Discovery conserve son 2×2 vertical historique sur Tout et ne réintroduit aucun scroller horizontal interne au pager catégories',
