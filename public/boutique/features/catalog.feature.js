...
module.exports = {
  ...
  perimeter: {
    in: [
      ...
      'fiche Discovery multi-actions dans le même #k-modal : request, quote, callback, call et whatsapp peuvent coexister sans changer le kind',
      'contact direct uniquement à partir de public_contact déjà autorisé par providers-services ; aucun fallback vers une identité provider privée',
    ],
    out: [
      'shell et layout globaux (platform-ops)',
      'panier personnel et commande (orders)',
      'classement produit backend (recommendations)',
      'autorisation d’exposition locale, actions_enabled, public_contact et cycle Inquiry — owner providers-services/recommendations',
  ...
  contract: {
    ...
    internalApi: [
      ...
      'b-modal-discovery-detail.js / setupDiscoveryModalDetail / renderDiscoveryModalDetail / normalizeActions — projection multi-actions dans le même #k-modal',
      'discovery-actions.js / requestDiscovery — producteur unique discovery:request pour request|quote|callback depuis le détail Komerce',
    ...
    consumes: [
      ...
      'providers-services — détail public Service/Physical Offer avec actions et public_contact contrôlé',
  ...
  invariants: [
    ...
    'le kind Discovery ne choisit jamais seul l interaction : une fiche service ou physical_offer peut cumuler request, quote, callback, call et whatsapp',
    'call et whatsapp sont rendus uniquement si public_contact contient la coordonnée explicitement autorisée ; aucun fallback vers un téléphone provider privé',
    'request, quote et callback utilisent discovery:request ; call et whatsapp sont des mises en relation directes sans mutation Inquiry',
