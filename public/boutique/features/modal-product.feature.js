...
module.exports = {
  ...
  contract: {
    ...
    consumes: [
      ...
      'boutique — b-modal-approche-c-hybrid.js compose uniquement le placement desktop des actions ; ne possède plus aucune logique paiement (déplacée dans b-modal-buybox-shared.js, MDP-2)',
  ...
  invariants: [
    ...
    'b-modal-approche-c-hybrid.js ne rend ni livraison, ni sous-total, ni paiement produit — composition desktop du placement des actions uniquement',
