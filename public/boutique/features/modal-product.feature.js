...
module.exports = {
  ...
  files: {
    ...
    tests: [
      ...
      '../tests/unit/modal-cart-sku-guard.test.js',
  ...
  contract: {
    ...
    internalApi: [
      ...
      'modal-cart-product-model.js / isModalPurchaseReady(product, detail, selection)',
  ...
  invariants: [
    ...
    'le CTA SKU ajoute une unité ; après ajout, le stepper ne peut muter que la ligne exacte de la sélection courante résolue par sku_id puis variant_combo',
    ...
    'mobile et desktop exposent les mêmes modes de paiement (Carte / Cash) via b-modal-buybox-shared.js / renderPaymentModes — composition différente, logique unique',
    ...
    'sur mobile, le hero conserve son ratio canonique 4:3 ; la réassurance occupe une seule ligne paiement/retrait, sans répéter le stock déjà affiché près du prix',
  ...
  contracts: {
    'render-static': [
      ...
      },
      {
        ...
        label:    'PDP curation waits for rendered suggestions and keeps generic discovery honest',
        mustContain: [
          /bus\.on\('modal:suggestions-rendered',\s*scheduleEnhanceCuration\)/m,
          /k-pdp-curation-section--editorial/m,
          /Quelques découvertes populaires/m,
        ],
      },
    ],
