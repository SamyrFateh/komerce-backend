...
CT.html.statusLabel = function(status) {
  var map = {
    pending: 'En attente', new: 'Nouveau', confirmed: 'Confirmé', ordered: 'Commandé',
...
CT.html.statusColor = function(status) {
  var map = {
    pending: 'var(--ct-orange)', new: 'var(--ct-blue)', confirmed: 'var(--ct-green)', ordered: 'var(--ct-cyan)',
...
CT.html.whatsappLink = function(phone, ref, status) {
  ...
  var messages = {
    pending: '🛒 Commande Komerce ' + ref + ' créée ! En attente de paiement.',
...
CT.views.global = {
  ...
  load: async function(el) {
    ...
    try {
      ...
      var funnelSteps = ['pending','confirmed','ordered','preparation','shipped','in_transit','available','collected'];
      var maxCount = 0;
