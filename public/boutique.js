...
(function () {
  ...
  function applyMobileStyles() {
    ...
    // ── CATEGORIES (chips) ──
    document.querySelectorAll('.k-chip').forEach(el => {
      Object.assign(el.style, {
        minWidth: '44px', maxWidth: '56px', gap: '3px',
        flexShrink: '0', padding: '2px 0', flex: '0 0 auto'
      });
    });
    document.querySelectorAll('.k-chip-photo').forEach(el => {
      Object.assign(el.style, {
        width: '36px', height: '36px', borderRadius: '50%'
      });
    });
    document.querySelectorAll('.k-chip-label').forEach(el => {
      Object.assign(el.style, {
    ...
    // ── PROMO RAIL ──
    const rail = document.getElementById('k-promo-rail');
    if (rail) {
      Object.assign(rail.style, {
        overflowX: 'auto', overflowY: 'hidden',
        scrollSnapType: 'x mandatory',
        display: 'flex', padding: '2px 0 6px'
      });
    }
    document.querySelectorAll('.k-promo-rail-inner').forEach(el => {
      Object.assign(el.style, {
        display: 'flex', flexWrap: 'nowrap', gap: '8px',
        width: 'max-content', animation: 'none', transform: 'none'
      });
    });
    document.querySelectorAll('.k-promo-card').forEach(el => {
      Object.assign(el.style, {
        flex: '0 0 110px', width: '110px', minWidth: '110px',
        maxWidth: '110px', scrollSnapAlign: 'start'
      });
    });
    document.querySelectorAll('.k-promo-card-img').forEach(el => {
      Object.assign(el.style, {
        width: '110px', height: '100px', maxHeight: '100px',
        objectFit: 'cover', borderRadius: '14px',
        filter: 'drop-shadow(0 2px 6px rgba(0,0,0,.12))',
        animation: 'none'
      });
    });
    document.querySelectorAll('.k-promo-badge').forEach(el => {
      Object.assign(el.style, {
        position: 'absolute', top: '5px', left: '5px',
        fontSize: '8px', padding: '2px 5px', zIndex: '2'
      });
    });
    document.querySelectorAll('.k-promo-card-info').forEach(el => {
      Object.assign(el.style, {
        padding: '3px 2px 0', minHeight: '0'
      });
    });
    document.querySelectorAll('.k-promo-card-name').forEach(el => {
      Object.assign(el.style, {
    ...
    document.querySelectorAll('.k-promo-card-price').forEach(el => {
      Object.assign(el.style, { fontSize: '11px', marginTop: '1px' });
    });
    document.querySelectorAll('.k-promo-card-old').forEach(el => {
    ...
    document.querySelectorAll('.k-card').forEach(el => {
      Object.assign(el.style, { borderRadius: '12px', overflow: 'hidden' });
    });
    document.querySelectorAll('.k-card-img-wrap').forEach(el => {
      Object.assign(el.style, {
        aspectRatio: '4/3', maxHeight: '140px', overflow: 'hidden', padding: '0'
      });
    });
    document.querySelectorAll('.k-card-img').forEach(el => {
      Object.assign(el.style, {
        width: '100%', height: '100%', objectFit: 'cover', padding: '0'
      });
    });
    document.querySelectorAll('.k-card-info').forEach(el => {
      Object.assign(el.style, { padding: '6px 8px 8px' });
    });
    document.querySelectorAll('.k-card-name').forEach(el => {
      Object.assign(el.style, {
        fontSize: '12px', overflow: 'hidden', display: '-webkit-box',
        webkitLineClamp: '2', webkitBoxOrient: 'vertical'
      });
    });
    document.querySelectorAll('.k-card-price').forEach(el => {
      Object.assign(el.style, { fontSize: '13px' });
    });
    document.querySelectorAll('.k-card-add').forEach(el => {
      Object.assign(el.style, { width: '32px', height: '32px', fontSize: '16px' });
    });

    // ── BOTTOM NAV ──
    const bnav = document.querySelector('.k-bnav');
    if (bnav) {
      Object.assign(bnav.style, {
    ...
    // ── HIDE BADGES ──
    document.querySelectorAll('.k-hero-badge').forEach(el => {
