...
> **LOT 0 CLOSED — 5/5.** Le STOP préalable est levé pour LOT 1A. LOT 2 UI reste hors séquence tant que les lots d'intégrité/truth-source prévus avant lui ne sont pas traités.
...
| **0C-eco** | Golden CDR CURRENT (filet de parité) | `tools/golden-cdr/golden/cdr.golden.json` | ✅ **capturé sur DB réelle le 2026-08-18** — 13 témoins, config `05d6b471d8b870ca`, `verify` local + CI verts |
...
**État du gate : 5/5 — LOT 0 CLOSED.**

## Gate de sortie du LOT 0

Les cinq critères sont satisfaits :
...
1. LOT 0 = 5/5 : fermé.
2. Ouvrir LOT 1A — intégrité silencieuse, sous Golden `BEFORE == AFTER`.
3. LOT 2 UI reste ultérieur : aucune refonte visuelle avant la sécurisation des vérités et agrégateurs prévue par les lots précédents.
