...
| economic-engine → market | BUSINESS_FEATURE_INTERFACE | RUNTIME_ONLY | business-feature | business-feature | static-code | technical-primitive | business-dependency-declare-candidate | — | `` |
