...
| auth-identity → auth-passkey | CROSS_FEATURE_DIRECT_IMPORT | RUNTIME_ONLY | business-feature | business-feature | static-code | import-mixed | boundary-remediation-required | direct-import | `` |
