...
| `auth-identity` | feature / transversal | production | 22 | 1/5 | integration:2 invariant:1 unit:5 | `PROVEN` | Aucun E2E fonctionnel possédé. 4/5 invariant(s) non exécutable(s). |
...
| `logistics` | feature / feature | production | 71 | 0/8 | integration:1 unit:35 | `PARTIAL` | Aucun E2E fonctionnel possédé. 8/8 invariant(s) non exécutable(s). |
...
| Feature | Nature | Cycle | Routes | Invariants (exéc./décl.) | Preuves exécutables | Couverture | Gap |
|---|---|---|---|---|---|---|---|
| `auth-passkey` | feature / transversal | production | 8 | 0/13 | unit:6 | `PARTIAL` | Aucun E2E fonctionnel possédé. Aucune preuve traversant les couches réelles (unitaire seul). 13/13 invariant(s) non exécutable(s). |
