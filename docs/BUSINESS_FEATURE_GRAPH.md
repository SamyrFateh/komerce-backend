...
| orders | infrastructure | static-code, interface | 52 | **DECLARED_AND_OBSERVED** |
...
| payments | infrastructure | static-code, interface | 40 | **DECLARED_AND_OBSERVED** |
