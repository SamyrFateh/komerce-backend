...
| dashboard | decision-signals (`decision-signals`) | ✔ |
...
- backend : 1004 fichier(s) `.js`/`.mjs` observés (canal A)
- boutique : 188 fichier(s) observés, dont 12 sous manifest non-canonique (canonicalFeature=null)
