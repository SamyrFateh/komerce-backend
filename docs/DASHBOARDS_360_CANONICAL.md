...
> Régénéré le 2026-09-20T19:35:58.222Z.
...
- Modules JS Canonical scannés : **62**
- Arêtes API tracées (`fetch()` vers `/api/`) : **66**
...
- ❓ `fetch()` dont l'URL n'a pas pu être résolue statiquement : **22**
...
| `market-settlement.js` | `?` | `url` | ❓ url non résolue |
