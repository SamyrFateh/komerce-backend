/**
 * KOMERCE — Serveur API v11.0 (Hub dashboard + Relay dashboard + suivi.html public)
 *
 * Point d'entrée Node.js + Express
 * Déployé sur Railway — PORT fourni par la variable d'environnement
 *
 * Changelog v11.0: routes/transit-dashboard.js ajouté (parcel-first)
...
const scansV2Router    = require('./routes/scans-v2');
