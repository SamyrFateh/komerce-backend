...
router.post('/seed-test', ...guard, async (req, res, next) => {
  ...
  try {
    ...
    const allScenarios = [
      { status: 'pending',     ref: 'KT-PENDING',     payment_mode: 'cash_relais', payment_status: 'pending',  ordered_at: null,        preparation_at: null,        shipped_at: null,        available_at: null,       collected_at: null,       cancelled_at: null },
      { status: 'confirmed',   ref: 'KT-CONFIRMED',   payment_mode: 'cash_relais', payment_status: 'paid',     ordered_at: null,        preparation_at: null,        shipped_at: null,        available_at: null,       collected_at: null,       cancelled_at: null },
