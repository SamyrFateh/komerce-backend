...
| T-007 | LANE-META | BLOCKED | claude-sonnet-session-2 | agent/lane-mobile-renderer | Ajouter les tests backend `product.series`, puis relancer le test contrat et la suite racine. |
...
| T-016 | LANE-DESKTOP-COMPOSITION | DONE | sonnet | agent/lane-mobile-renderer | T-023 est exécutable. |
