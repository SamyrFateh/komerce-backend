'use strict';
/**
 * .agent/generated/t030-capture.cjs
 *
...
const detailFixture = require('../../public/boutique/tests/fixtures/golden-elite-pro-detail.js');

const BASE_URL = process.env.T030_BASE_URL || 'http://127.0.0.1:4173/boutique/';
const EVIDENCE_ROOT = path.resolve(__dirname, '..', 'evidence', 'T-030');
