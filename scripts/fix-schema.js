...
`);
  ...
  // ── Migration 038 : Téléphone payeur ─────────────────────────────────────
  // Un user Komerce peut avoir un téléphone dédié au paiement (diaspora +33
  // OU local +269) distinct du tél principal `phone`.
  // Lot 3 : phone_beneficiary (bénéficiaire de retrait distinct) supprimée —
  // l'identité OTP de l'acheteur est désormais l'unique source de retrait.
