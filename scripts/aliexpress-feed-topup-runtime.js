/**
 * @komerce-arch
 * @role          aliexpress-feed-topup-script-runtime
 * @domain        catalog
 * @layer         script
 * @criticality   high
 * @inputs        sourcing_candidates, normalized AliExpress products
 * @outputs       bounded feed/category discovery plan and canonical import helpers
 * @depends       db.js, scripts/aliexpress-500-catalog-sync.js, services/suppliers/catalog-import-orchestrator.js
 * @used-by       scripts/aliexpress-500-feed-category-topup.js
 * @db-read       sourcing_candidates
 * @db-write      supplier_catalog_imports, sourcing_candidates, sourcing_candidate_events
 * @db-txn        catalog-import-orchestrator owns writes
