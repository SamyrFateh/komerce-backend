 ...
 *
 * Extrait de routes/hub-dashboard.js — GOD-FILES-6 (2026-05-25)
 *
 * Expose les 4 fonctions de lecture (GET) du hub dashboard :
 *   getDashboardKPIs()            → KPIs temps réel hub
 *   getQueue(filters)             → file de travail priorisée
 *   getOrderDetail(orderId)       → détail complet commande
 *   getValidation(orderId)        → validations anti-erreur
 *
 * Les mutations restent dans routes/hub-dashboard.js.
 * Aucune logique métier modifiée — déplacement pur.
 */
...
// ══════════════════════════════════════════════════════════════════════════
// getDashboardKPIs() — KPIs Hub (défensif)
// ══════════════════════════════════════════════════════════════════════════
...
// ══════════════════════════════════════════════════════════════════════════
// getValidation(orderId) — Validations anti-erreur avant action
// ══════════════════════════════════════════════════════════════════════════
async function getValidation(orderId) {
  const { rows: orderRows } = await db.query(
