/**
 * @komerce-arch
 * @role          economic-engine-pricing-recommend
...
async function computeRecommend(b = {}) {
  ...
  return {
    ...
    cout_total_kmf:            doctrine ? doctrine.fully_loaded_cost_reference_kmf : coutTotal,
    ...
    ...(doctrine ? {
      ...
      business_variable_cost_kmf:       doctrine.business_variable_cost_kmf,
      variable_cost_complete_kmf:       doctrine.variable_cost_complete_kmf,
      contribution_kmf:                 doctrine.contribution_kmf,
      structure_allocation_reference_kmf: doctrine.structure_allocation_reference_kmf,
      fully_loaded_cost_reference_kmf:  doctrine.fully_loaded_cost_reference_kmf,
    ...
    for (let i = 0; i < items.length; i++) {
      try {
        ...
        items[i] = {
          ...
          recommended_price_kmf:       doctrine.recommended_price_kmf,
          cost_total_kmf:              doctrine.fully_loaded_cost_reference_kmf,
