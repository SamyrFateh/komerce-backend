...
async function loadOrder360(order) {
  ...
  return Object.freeze({
    ...
    history: Object.freeze(historyResult.rows.map(row => Object.freeze({
      status: row.status,
      note: row.note || null,
      changed_by: row.changed_by_name || null,
      created_at: row.created_at,
    }))),
    scans: Object.freeze(scansResult.rows.map(row => Object.freeze({
      step: row.step,
      notes: row.notes || null,
      scanned_by: row.scanned_by_name || null,
      created_at: row.created_at,
    }))),
    incidents: Object.freeze(incidentsResult.rows.map(row => Object.freeze({
      type: row.type,
    ...
    notifications: Object.freeze(notificationsResult.rows.map(row => Object.freeze({
    ...
    documents: Object.freeze(documentsResult.rows.map(row => Object.freeze({
