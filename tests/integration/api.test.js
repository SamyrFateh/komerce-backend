/**
 * KOMERCE — Tests d'Intégration: Routes API (V2.6)
 *
 ...
 *   ✅ GET  /api/admin/orders — admin access
 *   ✅ POST /api/admin/reset — prod guard
 *   ✅ GET  /api/hub/pending — hub auth
 *   ✅ GET  /api/hub/today — hub stats
 *   ✅ 404 handling
 *
 * Prerequisites:
